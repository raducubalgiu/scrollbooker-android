...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun login(username: String, password: String): AuthResponse {
        ...
        return authApi.login(usernamePart, passwordPart).toDomain()
    }
    ...
    override suspend fun register(
        ...
        val request = AuthRequestDto.RegisterDto(email, password, roleName)
        return authApi.register(request).toDomain()
    }
