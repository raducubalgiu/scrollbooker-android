...
private constructor(
    ...
    private var mediaItemsList = listOf<Post>()
    ...
    private fun setMediaList(mediaList: List<Post>) {
    ...
    private fun addMediaItem(index: Int) {
        ...
        val mediaItem = (MediaItem.fromUri(mediaItemsList[index].mediaFiles.first().url))
