...
import com.example.scrollbooker.screens.auth.components.AuthErrorMessage
...
fun RegisterClientScreen(
    ...
    Column(
        ...
        Column(
            ...
            Column {
                AuthHeader(
                    headLine = stringResource(R.string.register),
                    subHeadline = stringResource(R.string.registerMessage)
                )
                ...
                emailError?.let { AuthErrorMessage(emailError) }
                ...
                AuthBodyNavigation(
                    ...
                    description = stringResource(R.string.alreadyHaveAnAccount),
                    action = stringResource(R.string.login)
                )
            }
